...
import { Menu, Bell, MessageSquare, Search, User, LogOut, Settings, HelpCircle } from 'lucide-react';
...
export const Layout: React.FC = () => {
  ...
  return (
    <div className={`flex h-screen w-screen overflow-hidden bg-app text-fg font-sans ${isAdmin ? 'admin-page' : ''}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden h-full">
        ...
        <header className="hidden md:flex items-center bg-transparent h-18 px-6 lg:px-8 shrink-0">
          <div className="max-w-7xl mx-auto w-full flex lg:grid lg:grid-cols-3 gap-6 items-center">
            ...
            {isAdmin ? (
              <div className="relative flex-1 lg:col-span-2 max-w-xs">
