...
import { MentorVerificationQueuePage } from './pages/admin/MentorVerificationQueue';
import { MentorVerificationDetailPage } from './pages/admin/MentorVerificationDetail';
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            />
            <Route
              path="/admin/mentor-verification/:requestId"
              element={
                <AdminGuard>
                  <MentorVerificationDetailPage />
                </AdminGuard>
              }
            />
            ...
            <Route path="/mentor/apply/profile" element={<MentorSetupProfile />} />
            <Route path="/mentor/verification" element={<MentorVerification />} />
            <Route path="/mentor/apply/verification" element={<MentorVerification />} />
