      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="meetmind-card p-5 relative overflow-hidden">
          <div className="flex justify-between items-start mb-2">
            <span className="text-brand-text-muted text-[10px] font-extrabold uppercase tracking-wider">Tổng người dùng</span>
        ...
        <div className="meetmind-card p-5 relative overflow-hidden">
          <div className="flex justify-between items-start mb-2">
            <span className="text-brand-text-muted text-[10px] font-extrabold uppercase tracking-wider">Mentor đã duyệt</span>
            <FileCheck className="w-5 h-5 text-brand-terracotta" />
          </div>
          <div className="text-3xl font-bold text-brand-text mb-0.5">48</div>
          <p className="text-[10px] text-brand-text-muted font-semibold">8 hồ sơ chờ duyệt</p>
        </div>

        <div className="meetmind-card p-5 relative overflow-hidden">
          <div className="flex justify-between items-start mb-2">
            <span className="text-brand-text-muted text-[10px] font-extrabold uppercase tracking-wider">Tổng buổi đặt lịch</span>
        ...
        <div className="meetmind-card p-5 relative overflow-hidden">
          <div className="flex justify-between items-start mb-2">
            <span className="text-brand-text-muted text-[10px] font-extrabold uppercase tracking-wider">Đánh giá chung</span>
            <Star className="w-5 h-5 fill-amber-400 text-amber-500" />
          </div>
          <div className="text-3xl font-bold text-brand-text mb-0.5">4.82/5</div>
          <p className="text-[10px] text-brand-text-muted font-semibold">Tích cực 98.4%</p>
        </div>
      </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3 text-xs leading-normal">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-brand-grey">2 giờ trước</span>
                </div>
              </div>
              ...
              <div className="flex gap-3 text-xs leading-normal">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-brand-grey">5 giờ trước</span>
                </div>
              </div>
              ...
              <div className="flex gap-3 text-xs leading-normal">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-brand-grey">1 ngày trước</span>
                </div>
              </div>
            </div>
          </div>
